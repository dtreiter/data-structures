class TrinaryTest {
	static boolean testInsert0() {
		...
		String breadth = head.treeBreadth();
		String preorder = head.treePreorder();
	...
	static boolean testDelete2() { // delete the head
		TrinaryNode head = new TrinaryNode(50);
		head.insert(25);
		head.insert(1);
		head.insert(30);
	...
	public static void main(String[] args) {
		// Be sure to run 'java -ea FileName' to enable assertions
